  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.status === 200) {
        ...
        setOtherValues({ module: '', profession: '', referral: '' });
        setLastClicked({});
      } else {
      ...
      <div className={`enquiry-form-container ${isSidebarOpen ? 'with-sidebar' : 'without-sidebar'}`}>
        ...
        <form className="enquiry-form" onSubmit={handleSubmit}>
          ...
          {[
            ...
            { label: 'How soon will the student able to start? ', name: 'experience', options: ['Immediate', 'After 15 days', 'After 10 days', 'After 1 Month'] },
            ...
            { label: 'Highest Qualification', name: 'qualification', options: ['Diploma', "Bachelor's Degree", "Master's Degree"] },
